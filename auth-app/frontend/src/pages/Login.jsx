  ...
  return (
    <div style={{ minHeight: '100vh', background: '#181e1f', color: '#e6ffe6', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <form onSubmit={handleSubmit} style={{ background: '#222', padding: 32, borderRadius: 12, boxShadow: '0 4px 32px #01442155', minWidth: 320 }}>
        <h2 style={{ color: '#20c997', marginBottom: 16 }}>Login</h2>
        ...
        <button type="submit" style={{ width: '100%', background: '#20c997', color: '#181e1f', padding: 10, border: 0, borderRadius: 6, cursor: 'pointer', fontWeight: 'bold' }}>Login</button>
        <p style={{ marginTop: 16, color: '#adf7b6' }}>No account? <span style={{ color: '#20c997', cursor: 'pointer' }} onClick={() => navigate('/register')}>Register</span></p>
      </form>
    </div>
  );
}
